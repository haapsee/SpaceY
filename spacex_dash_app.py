...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        fig = px.pie(spacex_df, names='class', title='Success vs Failed Launches')
    else:
...
def get_scatter_chart(entered_site, payload_range):
    if entered_site == 'ALL':
        ...
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category', title=f'Payload vs Success for site {entered_site}')
    return fig
